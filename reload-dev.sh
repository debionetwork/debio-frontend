...
docker run -d --name=debio_frontend_dev --env=debioenv=development -v /etc/localtime:/etc/localtime:ro -p 0.0.0.0:8080:80 --restart=always asia.gcr.io/degenics/debio_frontend_dev:latest
