  ...
  computed: {
    ...
    fileInputRules() {
      return [
        ...
        value => (!!value && (value.type === "application/pdf" || value.type === "application/msword" || value.type === "application/vnd.openxmlformats-officedocument.wordprocessingml.document")) || 'The files uploaded are not in the supported file formats.',
      ]
    },
