...
export default Object.freeze({
  ...
  PASSWORD: val => (val && val.length >= 8) && /^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$/.test(val) || errorMessages.PASSWORD(8, "at least UPPER/lowercase characters, number and special character in (!@#$%^&*)")
})
