      ...
      try {
        ...
        api.query.system.events((events) => {
          events.forEach((record) => {
            const { event } = record;
            if (event.section == "orders", event.section == "rewards" || event.section == "serviceRequest" || event.section == "services" || event.section == "labs" || event.section == "orders" || event.section == "geneticTesting" || event.section == "balances" || event.section == "electronicMedicalRecord") {
